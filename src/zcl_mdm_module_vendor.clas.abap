CLASS zcl_mdm_module_vendor DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES : BEGIN OF Companycodetable4,
              ...
              RecType  TYPE string,
              deletevalue      TYPE string,
              Excemptionnumber         TYPE string,
              Exem                      TYPE string,
              Exemptfr                   TYPE string,
              ExemptTo                  TYPE string,
              Exemptreason                TYPE string,
              Exemptreasondescription     TYPE string,
 ...
 "ID": "001",
  ...
  "RelationshipCatalog": "FBUR001 Has Contact Person"
...
wa_zmdm_wiholding_t-excemptionnumber           =  WA10-excemptionnumber       .
wa_zmdm_wiholding_t-exem                       =  WA10-exem                   .

IF WA10-exemptfr IS NOT INITIAL .
wa_zmdm_wiholding_t-exemptfr                   =  WA10-exemptfr+0(4) && WA10-exemptfr+5(2) && WA10-exemptfr+8(2)     .
ENDIF.
IF WA10-exemptto IS NOT INITIAL .
wa_zmdm_wiholding_t-exemptto                   =  WA10-exemptto+0(4) && WA10-exemptto+5(2) && WA10-exemptto+8(2)         .
ENDIF.

wa_zmdm_wiholding_t-exemptreason               =  WA10-exemptreason           .
wa_zmdm_wiholding_t-exemptreasondescription    =  WA10-exemptreasondescription.
    ...
    ENDLOOP.
     ...
     READ TABLE respo-generaldata  INTO DATA(TAS) INDEX 1.
      ...
      DATA WA_zrelationshiptab TYPE zrelationshiptab .
       ...
       ENDIF.
        ...
        MODIFY zrelationshiptab FROM @WA_zrelationshiptab .
